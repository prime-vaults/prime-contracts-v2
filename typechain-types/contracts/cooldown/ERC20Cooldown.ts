...
export interface ERC20CooldownInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "s_expiryWindow",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setExpiryWindow",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ERC20Cooldown extends BaseContract {
  ...
  s_expiryWindow: TypedContractMethod<[], [bigint], "view">;
  ...
  setExpiryWindow: TypedContractMethod<
    [window_: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "s_expiryWindow"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setExpiryWindow"
  ): TypedContractMethod<[window_: BigNumberish], [void], "nonpayable">;
  getFunction(
