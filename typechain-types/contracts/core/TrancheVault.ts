...
export namespace WithdrawRequestedEvent {
  export type InputTuple = [
    ...
    shares: BigNumberish,
    baseAmount: BigNumberish,
    result: CDOWithdrawResultStruct
  ];
  export type OutputTuple = [
    owner: string,
    receiver: string,
    shares: bigint,
    baseAmount: bigint,
    result: CDOWithdrawResultStructOutput
  ];
  export interface OutputObject {
    owner: string;
    receiver: string;
...
export interface TrancheVault extends BaseContract {
  ...
  maxRedeem: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;

  maxWithdraw: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  filters: {
    ...
    "WithdrawRequested(address,address,uint256,uint256,tuple)": TypedContractEvent<
      WithdrawRequestedEvent.InputTuple,
      WithdrawRequestedEvent.OutputTuple,
      WithdrawRequestedEvent.OutputObject
    >;
