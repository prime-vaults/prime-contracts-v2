...
export interface SUSDaiAprProviderInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SUSDaiAprProvider extends BaseContract {
  connect(runner?: ContractRunner | null): SUSDaiAprProvider;
  waitForDeployment(): Promise<this>;

  interface: SUSDaiAprProviderInterface;
